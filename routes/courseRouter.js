...
// #region swagger doc
  ...
  */
  ...
  validateId, courseController.getOneCourse);
router.get('/',
// #region swagger doc
  /* #swagger.tags = ['Course'] */
...
// #region swagger doc
  ...
  /* #swagger.responses[201] = {
    ...
    */
  // #endregion swagger doc
  validateCourse, courseController.createCourse);
router.put('/:id',
// #region swagger doc
  /* #swagger.tags = ['Course'] */
  ...
  */
  /* #swagger.responses[200] = {
    ...
    */
  // #endregion swagger doc
  validateId, validateCourse, courseController.updateCourse);
router.delete('/:id',
// #region swagger doc
  /* #swagger.tags = ['Course'] */
  ...
  */
  ...
  // #endregion swagger doc
  validateId, courseController.deleteCourse);
